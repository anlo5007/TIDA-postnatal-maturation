# Membrane-potential autocorrelogram analysis

MATLAB code used to quantify membrane-potential oscillations from whole-cell
current-clamp recordings in *TODO: manuscript title*.
...
2. Open `autocorrelogram_analysis.m` and edit the `CONFIGURATION` section.
...
| File | Contents |
|---|---|
| `autocorrelogram_analysis.m` | Everything: configuration, the pipeline, and all local functions |
| `README.md` | This file |
